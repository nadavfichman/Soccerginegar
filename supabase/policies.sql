...
--
-- טבלאות settings, login_attempts (שם שמורה סיסמת האדמין-על) ו-client_errors
-- (לוג שגיאות קליינט, ר' schema_additions.sql/functions.sql) יש להן RLS
-- מופעל בלי אף מדיניות בכלל — כלומר חסומות לגמרי מגישה ציבורית, גם לקריאה.
-- זה תקין ומכוון, לא צריך לשנות.
-- ============================================================================
